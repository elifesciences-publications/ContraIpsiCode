function [pc1,pc2,pc3,pc4,pc5,pc6,pc7,pc8,pi1,pi2,pi3,pi4,pi5,pi6,pi7,pi8 ] = get_neuron_data_timing( convolved_H_all,bin_size )
...
%   Detailed explanation goes here
    ...
    for i=1:numb_days
        ...
        pert1c=extract_neuron_numb_per_baseline(convolved_H,1);
        pert2c=extract_neuron_numb_per_baseline(convolved_H,2);
        pert3c=extract_neuron_numb_per_baseline(convolved_H,3);
        pert4c=extract_neuron_numb_per_baseline(convolved_H,4);%
        pert5c=extract_neuron_numb_per_baseline(convolved_H,5);
        pert6c=extract_neuron_numb_per_baseline(convolved_H,6);
        pert7c=extract_neuron_numb_per_baseline(convolved_H,7);
        pert8c=extract_neuron_numb_per_baseline(convolved_H,8);%

        %get ipsilateral neurons at steady state
        pert1i=extract_neuron_numb_per_baseline(convolved_H,10);
        pert2i=extract_neuron_numb_per_baseline(convolved_H,11);
        pert3i=extract_neuron_numb_per_baseline(convolved_H,12);
        pert4i=extract_neuron_numb_per_baseline(convolved_H,13);%
        pert5i=extract_neuron_numb_per_baseline(convolved_H,14);
        pert6i=extract_neuron_numb_per_baseline(convolved_H,15);
        pert7i=extract_neuron_numb_per_baseline(convolved_H,16);
        pert8i=extract_neuron_numb_per_baseline(convolved_H,17);%
