function [pd ] = get_pert_pd_old( pert1c,pert2c,pert3c,pert4c,pert5c,pert6c,pert7c,pert8c)
...
%             
            ...
            a=100;
            b=200;
            pert_baseline=[pert1c(i,a:b);pert2c(i,a:b);pert3c(i,a:b);pert4c(i,a:b);...
                pert5c(i,a:b);pert6c(i,a:b);pert7c(i,a:b);pert8c(i,a:b);];
            
            pert_array=mean(pert_array,2);
            pert_baseline=mean(pert_baseline,2);
            pert_array=pert_array-pert_baseline;
...
%             pd_array(i,:)=abs(pd_array(i,:));%*sign(mean(pd_array(i,250:300),2));
