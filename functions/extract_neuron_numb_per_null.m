function [ neuron_selected ] = extract_neuron_numb_per_null( Data_str,start_ep,end_ep, varargin )
...
%         if strcmp(test(1:5),'Neuro')
    ...
    neuron_selected=zeros(numb_files,neuron_numb,end_ep-start_ep+1);
    for i=1:numb_files
        start_time=int32(pert_time(i)+start_ep);
        end_time=int32(pert_time(i)+end_ep);
