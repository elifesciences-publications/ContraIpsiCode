function [ neuron_selected ] = extract_neuron_numb_per_trials_onset( Data_str, varargin )
...
%         if strcmp(test(1:5),'Neuro')
    ...
    neuron_selected=zeros(numb_files,neuron_numb,501);
    for i=1:numb_files
        start_time=int32(pert_time(i)-200);
