function [ neuron_selected ] = extract_neuron_numb_pert_tuned( Data_str, varargin )
...
%   Detailed explanation goes here
    ...
    neuron_selected=zeros(numb_files,neuron_numb,301);
    for i=1:numb_files
        start_time=int32(pert_time(i)+0);
        end_time=int32(pert_time(i)+300);
